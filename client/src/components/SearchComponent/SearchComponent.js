...
const SearchComponent = (props) => {
	...
	const Search = async (e) => {
		...
		if (navigator.onLine) SuggestSearch(e.target.value, abortController).then(v => v && v.length ? setQueryArray(v) : setQueryArray([]));
...
export default connect(mapStateToProps)(pure(SearchComponent));
